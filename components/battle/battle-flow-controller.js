...
class BattleFlowController {
    constructor(actors, inventories, commands, messages, locale, playerParty, enemyParty) {
        this.actors = actors;
        ...
        this.actionResolver = new ActionResolver(actors, inventories, commands, messages, locale);
